...
int CPU::INC_16(u16& dst)
{
	dst++;
	return 8;
}

int CPU::DEC_16(u16& dst)
{
	dst--;
	return 8;
}

int CPU::ADD_16(u16& dst, u16 src)
{
	u32 result = dst + src;
	u8 zeroFlag = CHK_FLAG(FLAG_Z);
	F = 0;
	if (result > 0xFFFF) {
		SET_FLAG(FLAG_C);
	}
	if ((result & 0x0F00) > 0x0F00) {
		SET_FLAG(FLAG_H);
	}
	F |= zeroFlag;
	dst = result;
...
int CPU::ADD_16_SP()
{
	u32 result = SP + (s8)m_MMU->read8(PC++);
	F = 0;
	if (result > 0xFFFF) {
		SET_FLAG(FLAG_C);
	}
...
int CPU::opcode03() { return INC_16(BC); }
...
int CPU::opcode07() { return RLCA(); }

int CPU::opcode08() { LD_16_SP(); return 20; }

int CPU::opcode09() { return ADD_16(HL, BC); }

int CPU::opcode0A() { LD_8_ind(A, BC); return 8; }

int CPU::opcode0B() { return DEC_16(BC); }
...
int CPU::opcode13() { return INC_16(DE); }
...
int CPU::opcode17() { return RLA(); }

int CPU::opcode18() { return JR(true); }

int CPU::opcode19() { return ADD_16(HL, DE); }

int CPU::opcode1A() { LD_8_ind(A, DE); return 8; }

int CPU::opcode1B() { return DEC_16(DE); }
...
int CPU::opcode23() { return INC_16(HL); }
...
int CPU::opcode27() { return DAA(); }

int CPU::opcode28() { return JR(CHK_FLAG(FLAG_Z)); }

int CPU::opcode29() { return ADD_16(HL, HL); }

int CPU::opcode2A() { LDI_ind(); return 8; }

int CPU::opcode2B() { return DEC_16(HL); }
...
int CPU::opcode33() { return INC_16(SP); }
...
int CPU::opcode37() { return SCF(); }

int CPU::opcode38() { return JR(CHK_FLAG(FLAG_C)); }

int CPU::opcode39() { return ADD_16(HL, SP); }

int CPU::opcode3A() { LDD_ind(); return 8; }

int CPU::opcode3B() { return DEC_16(SP); }
...
int CPU::opcode46() { LD_8_ind(B, HL); return 8; }
...
int CPU::opcode56() { LD_8_ind(D, HL); return 8; }
...
int CPU::opcode66() { LD_8_ind(H, HL); return 8; }
...
int CPU::opcodeC0() { return RET(!CHK_FLAG(FLAG_Z)); }
...
int CPU::opcodeC7() { return RST(0x00); }

int CPU::opcodeC8() { return RET(CHK_FLAG(FLAG_Z)); }
...
int CPU::opcodeCC() { return CALL(CHK_FLAG(FLAG_Z)); }

int CPU::opcodeCD() { return CALL(); }

int CPU::opcodeCE() { ADC_8(m_MMU->read8(PC++)); return 8; }

int CPU::opcodeCF() { return RST(0x08); }


int CPU::opcodeD0() { return RET(!CHK_FLAG(FLAG_C)); }
...
int CPU::opcodeD4() { return CALL(!CHK_FLAG(FLAG_C)); }

int CPU::opcodeD5() { PUSH(DE); return 16; }

int CPU::opcodeD6() { SUB_8(m_MMU->read8(PC++)); return 8; }

int CPU::opcodeD7() { return RST(0x10); }

int CPU::opcodeD8() { return RET(CHK_FLAG(FLAG_C)); }
...
int CPU::opcodeDC() { return CALL(CHK_FLAG(FLAG_C)); }
...
int CPU::opcodeDE() { SBC_8(m_MMU->read8(PC++)); return 8; }

int CPU::opcodeDF() { return RST(0x18); }
...
int CPU::opcodeE7() { return RST(0x20); }

int CPU::opcodeE8() { return ADD_16_SP(); }
...
int CPU::opcodeEF() { return RST(0x28); }
...
int CPU::opcodeF7() { return RST(0x30); }
...
int CPU::opcodeFF() { return RST(0x38); }
